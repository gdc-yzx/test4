  ...
  <div class="control_content">
    <div class="control_content_left">
      ...
      >
        ...
        <el-submenu index="2">
          <template slot="title">
            <span slot="title">广大通</span>
          </template>
          <el-submenu index="2-1" style="background-color: #F6F6F6;">
            <span slot="title">直销最终用户A</span>
            <el-menu-item index="2-1-1" style="text-align: left">POP1</el-menu-item>
            <el-menu-item index="2-1-2" style="text-align: left">POP2</el-menu-item>
            <el-menu-item index="2-1-3" style="text-align: left">POP3</el-menu-item>
            <el-menu-item index="2-1-4" style="text-align: left">POP4</el-menu-item>
          </el-submenu>
        </el-submenu>
      </el-menu>
    </div>
  ...
  methods: {
    ...
    initEcharts_wan(){
      ...
      this.chartInstane_wan.setOption({
        ...
        color:['#FC7270','#0458CC','#2C89E2','#0458CC'],
        legend: {
          data: ['接入流量','输出流量'],
          x:'right',
          padding:[20,60,0,0]
